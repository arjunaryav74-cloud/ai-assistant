import { getGcpTtsClient, isGcpVoiceConfigured } from "../gcp/client";
import { normalizeGoogleTtsVoice } from "@shared/google-voices";
import type { GoogleVoiceQuality } from "@shared/types";
