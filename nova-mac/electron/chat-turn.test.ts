...
vi.mock("./memory/index", () => ({
  ...
  formatRuntimeClockForPrompt: vi.fn().mockReturnValue("Now: July 1, 12:00 PM UTC"),
  MAC_TEXT_SYSTEM_PROMPT: "You are Nova.",
  MAC_VOICE_SYSTEM_PROMPT: "You are Nova (voice).",
