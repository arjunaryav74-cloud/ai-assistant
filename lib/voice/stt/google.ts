import { getGcpSpeechClient, isGcpVoiceConfigured } from "@/lib/gcp/client";
import { resolveGoogleSttPipeline } from "@/lib/voice/google-quality";
import { transcribeWithGoogleV2 } from "@/lib/voice/stt/google-v2";
