import { ensureAudioPlaybackUnlocked } from "@/lib/voice/audio-unlock";
import { SentenceBuffer } from "@/lib/voice/sentence-buffer";
import { prepareSpeechChunks } from "@/lib/voice/tts-text";
import { synthesizeChunk } from "@/lib/voice/tts";
...
export class VoicePlayer {
  ...
  async play(markdown: string, options: VoicePlayerOptions): Promise<void> {
    ...
    try {
      const prefetches: Promise<Blob>[] = chunks.map((chunk, i) =>
