...
import { hasGmailComposeScope, hasYoutubeReadScope, mergeScopes } from "@/lib/google/scopes";
import type {
  GoogleConnectionStatus,
  ServiceConnectionStatus,
} from "@/lib/google/connection-types";
...
export type { GoogleConnectionStatus, ServiceConnectionStatus } from "@/lib/google/connection-types";
...
export async function upsertGoogleServiceToken(
  ...
  // Preserve scopes from other connected services; use only what Google
  // actually granted for this service (not the desired set) so we never
  // claim a scope the user declined (e.g. gmail.compose).
